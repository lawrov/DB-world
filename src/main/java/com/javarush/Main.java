...
public class Main {
    ...
    private String getPercent(long redisTime, long mysqlTime){
        int result;
        if (redisTime < mysqlTime){
            result = 100 - (int) (redisTime * 100 / mysqlTime);
            return "Redis is " + result + "% faster";
        } else if (redisTime > mysqlTime){
            result = 100 - (int) (mysqlTime * 100 / redisTime);
            return "MySQL is " + result + "% faster";
        } else {
            return "The Friendship Won!";
        }
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("%s:\t%d ms\n", "MySQL", mysqlTime);
        System.out.println("===========");
        System.out.println(main.getPercent(redisTime, mysqlTime));
